...
public:
	...
	// Get all current lamps that have been identified
	vector<Lamp> getIdentifiedLamps();
...
private:
	...
	// TODO: getIDdLamps(); // get light sources that have been successfully
	// identified as a lamp with a given ID
